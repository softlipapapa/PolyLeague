...
// pUSD (Polymarket USD) — V2 collateral token, 1:1 backed by USDC
...
// V1 exchange addresses (kept for backward compat with existing approvals)
...
export const CTF_EXCHANGE_ADDRESS_V2 =
  "0xE111180000d2663C0091e4f400237545B87B996B" as const;

export const NEG_RISK_CTF_EXCHANGE_ADDRESS_V2 =
